...
export class FilesService {
    ...
    // [ph]
    updateFileSettingsPh(
        fileId: string,
        newPrintSettings: object,
        productID: string,
    ): Observable<any> {
        const url = `${BACKEND_URL}/updatefilesettingsph/${fileId}`;
        const body = { printSettings: newPrintSettings, productID: productID };
        return this.http.put(url, body);
    }

    // [plotter]
    deleteFile(currentFile: any) {
        const url = `${BACKEND_URL}/deletefile/${currentFile._id}`;
        return this.http.delete(url);
    }
    // [express]
    deleteFileExpress(currentFile: any) {
        const url = `https://img-express.eazix.io/api/files/delete/${currentFile._id}`;
        return this.http.delete(url);
    }

    // [plotter]
    deleteImage(currentFile: any, imageIndex: number) {
        console.log("()()()() deleteImage");
        console.log("()()()() currentFile", currentFile);
        console.log("()()()() imageIndex", imageIndex);
        const url = `${BACKEND_URL}/deleteimage/${currentFile._id}/${imageIndex}`;
        return this.http.delete(url);
    }
    // [express]
    deleteImageExpress(currentFile: any, currentImage: any) {
        console.log("()()()() deleteImage");
        console.log("()()()() currentFile", currentFile);
        console.log("()()()() currentImage", currentImage);
        const url = `https://img-express.eazix.io/api/files/delete/${currentFile._id}/${currentImage._id}`;
        return this.http.delete(url);
    }
    ...
    applyToAll(
        ...
        console.log("()()()() printSettings", newPrintSettings);
